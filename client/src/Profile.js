    ...
    return (
      <div>
        <nav className="p-2 d-flex justify-content-around fixed-bottom navbar-light bg-light">
          ...
          <a className='text-dark text-center' role="button" onClick={(e) => this.props.activatePage(e, 'potentialMatch', 'profile')}> <FontAwesomeIcon icon='list' className='iconSize'/><div className='fontSize'>Discover</div></a>
        </nav>
